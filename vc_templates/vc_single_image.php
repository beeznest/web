...
$caption = $img_link_large = $link = $img_link_target = $alignment = $el_class = $el_id = $css_animation = $style = $external_style = $border_color = $css = $icon_class = '';
...
switch ( $source ) {
	...
	case 'external_link':
		...
		$img = array(
			'thumbnail' => '<img class="vc_single_image-img img-fluid" ' . $hwstring . ' src="' . $custom_src . '" />',
		);
		break;
