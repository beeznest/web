...
function pergo_styles() {
	...
	wp_enqueue_style( 'bootstrap', PERGO_URI. '/css/bootstrap.min.css', false, '4.0.0' );
	...
	wp_enqueue_style( 'slick', PERGO_URI. '/css/slick.css', false, '1.1' );
	...
	if( function_exists('is_woocommerce') ){
    	wp_enqueue_style( 'pergo-woocommerce', PERGO_URI . '/css/woocommerce.css', array('bootstrap'), PERGO_VERSION );
	}

	wp_enqueue_style( 'pergo-default-style', PERGO_URI. '/css/style.css', false, PERGO_VERSION );
...
function pergo_scripts() {
	...
	wp_enqueue_script( 'slick', PERGO_URI .'/js/slick.min.js', array('jquery'),'1.0',true );
