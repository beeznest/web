...
function pergo_import_demo_data() {
  ...
  return array(    
    array(
      ...
      'import_customizer_file_url' => PERGO_URI.'/admin/demo-data/customizer.dat', 
      'import_preview_image_url'   => '//jthemes.org/wp/pergo/assests/images/layout-1.jpg',
      'preview_url'                => '//jthemes.org/wp/pergo/demos/startup-agency',
    ),
    array(
      ...
      'import_widget_file_url'     => PERGO_URI.'/admin/demo-data/widgets.wie',
      'import_customizer_file_url' => PERGO_URI.'/admin/demo-data/customizer.dat', 
      'import_preview_image_url'   => '//jthemes.org/wp/pergo/assests/images/layout-2.jpg',
      'preview_url'                => '//jthemes.org/wp/pergo/demos/design-studio',
    ),
    array(
      ...
      'import_widget_file_url'     => PERGO_URI.'/admin/demo-data/widgets.wie',
      'import_customizer_file_url' => PERGO_URI.'/admin/demo-data/customizer.dat', 
      'import_preview_image_url'   => '//jthemes.org/wp/pergo/assests/images/layout-3.jpg',
      'preview_url'                => '//jthemes.org/wp/pergo/demos/web-design-agency',
    ),
    array(
      ...
      'import_widget_file_url'     => PERGO_URI.'/admin/demo-data/widgets.wie',
      'import_customizer_file_url' => PERGO_URI.'/admin/demo-data/customizer.dat', 
      'import_preview_image_url'   => '//jthemes.org/wp/pergo/assests/images/layout-4.jpg',
      'preview_url'                => '//jthemes.org/wp/pergo/demos/business-agency',
    ),
    array(
      ...
      'import_widget_file_url'     => PERGO_URI.'/admin/demo-data/widgets.wie',
      'import_customizer_file_url' => PERGO_URI.'/admin/demo-data/customizer.dat', 
      'import_preview_image_url'   => '//jthemes.org/wp/pergo/assests/images/layout-5.jpg',
      'preview_url'                => '//jthemes.org/wp/pergo/demos/startup-1',
    ),
    array(
      ...
      'import_widget_file_url'     => PERGO_URI.'/admin/demo-data/widgets.wie',
      'import_customizer_file_url' => PERGO_URI.'/admin/demo-data/customizer.dat', 
      'import_preview_image_url'   => '//jthemes.org/wp/pergo/assests/images/layout-6.jpg',
      'preview_url'                => '//jthemes.org/wp/pergo/demos/business-consultancy',
    ),
    array(
      ...
      'import_widget_file_url'     => PERGO_URI.'/admin/demo-data/widgets.wie',
      'import_customizer_file_url' => PERGO_URI.'/admin/demo-data/customizer.dat', 
      'import_preview_image_url'   => '//jthemes.org/wp/pergo/assests/images/layout-7.jpg',
      'preview_url'                => '//jthemes.org/wp/pergo/demos/creative-agency',
    ),
    array(
      ...
      'import_widget_file_url'     => PERGO_URI.'/admin/demo-data/widgets.wie',
      'import_customizer_file_url' => PERGO_URI.'/admin/demo-data/customizer.dat', 
      'import_preview_image_url'   => '//jthemes.org/wp/pergo/assests/images/layout-8.jpg',
      'preview_url'                => '//jthemes.org/wp/pergo/demos/app-showcase',
    ),
    array(
      ...
      'import_widget_file_url'     => PERGO_URI.'/admin/demo-data/widgets.wie',
      'import_customizer_file_url' => PERGO_URI.'/admin/demo-data/customizer.dat', 
      'import_preview_image_url'   => '//jthemes.org/wp/pergo/assests/images/layout-9.jpg',
      'preview_url'                => '//jthemes.org/wp/pergo/demos/innovation-agency',
    ),
    array(
      ...
      'import_widget_file_url'     => PERGO_URI.'/admin/demo-data/widgets.wie',
      'import_customizer_file_url' => PERGO_URI.'/admin/demo-data/customizer.dat', 
      'import_preview_image_url'   => '//jthemes.org/wp/pergo/assests/images/layout-10.jpg',
      'preview_url'                => '//jthemes.org/wp/pergo/demos/freelancer-1',
    ),
    array(
      ...
      'import_widget_file_url'     => PERGO_URI.'/admin/demo-data/widgets.wie',
      'import_customizer_file_url' => PERGO_URI.'/admin/demo-data/customizer.dat', 
      'import_preview_image_url'   => '//jthemes.org/wp/pergo/assests/images/layout-11.jpg',
      'preview_url'                => '//jthemes.org/wp/pergo/demos/marketing-agency',
    ),
    array(
      ...
      'import_widget_file_url'     => PERGO_URI.'/admin/demo-data/widgets.wie',
      'import_customizer_file_url' => PERGO_URI.'/admin/demo-data/customizer.dat', 
      'import_preview_image_url'   => '//jthemes.org/wp/pergo/assests/images/layout-12.jpg',
      'preview_url'                => '//jthemes.org/wp/pergo/demos/designer-portfolio',
    ),
    array(
      ...
      'import_widget_file_url'     => PERGO_URI.'/admin/demo-data/widgets.wie',
      'import_customizer_file_url' => PERGO_URI.'/admin/demo-data/customizer.dat', 
      'import_preview_image_url'   => '//jthemes.org/wp/pergo/assests/images/layout-13.jpg',
      'preview_url'                => '//jthemes.org/wp/pergo/demos/creative-business',
    ),
    array(
      ...
      'import_widget_file_url'     => PERGO_URI.'/admin/demo-data/widgets.wie',
      'import_customizer_file_url' => PERGO_URI.'/admin/demo-data/customizer.dat', 
      'import_preview_image_url'   => '//jthemes.org/wp/pergo/assests/images/layout-14.jpg',
      'preview_url'                => '//jthemes.org/wp/pergo/demos/digital-agency',
    ),
    array(
      ...
      'import_widget_file_url'     => PERGO_URI.'/admin/demo-data/widgets.wie',
      'import_customizer_file_url' => PERGO_URI.'/admin/demo-data/customizer.dat', 
      'import_preview_image_url'   => '//jthemes.org/wp/pergo/assests/images/layout-15.jpg',
      'preview_url'                => '//jthemes.org/wp/pergo/demos/branding-agency',
    ),
    array(
      ...
      'import_widget_file_url'     => PERGO_URI.'/admin/demo-data/widgets.wie',
      'import_customizer_file_url' => PERGO_URI.'/admin/demo-data/customizer.dat', 
      'import_preview_image_url'   => '//jthemes.org/wp/pergo/assests/images/layout-16.jpg',
      'preview_url'                => '//jthemes.org/wp/pergo/demos/freelancer-2',
    ),
    array(
      ...
      'import_widget_file_url'     => PERGO_URI.'/admin/demo-data/widgets.wie',
      'import_customizer_file_url' => PERGO_URI.'/admin/demo-data/customizer.dat', 
      'import_preview_image_url'   => '//jthemes.org/wp/pergo/assests/images/layout-17.jpg',
      'preview_url'                => '//jthemes.org/wp/pergo/demos/startup-2',
    ),
    array(
      ...
      'import_widget_file_url'     => PERGO_URI.'/admin/demo-data/widgets.wie',
      'import_customizer_file_url' => PERGO_URI.'/admin/demo-data/customizer.dat', 
      'import_preview_image_url'   => '//jthemes.org/wp/pergo/assests/images/layout-18.jpg',
      'preview_url'                => '//jthemes.org/wp/pergo/demos/classic-business',
    ),
    array(
      ...
      'preview_url'                => '//jthemes.org/wp/pergo/demos/medical-health/',
    ),
    array(
    ...
    array(
      ...
      'import_widget_file_url'     => PERGO_URI.'/admin/demo-data/widgets.wie',
      'import_customizer_file_url' => PERGO_URI.'/admin/demo-data/customizer.dat', 
      'import_preview_image_url'   => '//jthemes.org/wp/pergo/assests/images/layout-21.jpg',
    ...
    array(
      ...
      'import_widget_file_url'     => PERGO_URI.'/admin/demo-data/widgets.wie',
      'import_customizer_file_url' => PERGO_URI.'/admin/demo-data/customizer.dat', 
      'import_preview_image_url'   => '//jthemes.org/wp/pergo/assests/images/layout-22.jpg',
    ...
    array(
      ...
      'import_widget_file_url'     => PERGO_URI.'/admin/demo-data/widgets.wie',
      'import_customizer_file_url' => PERGO_URI.'/admin/demo-data/customizer.dat', 
      'import_preview_image_url'   => '//jthemes.org/wp/pergo/assests/images/layout-23.jpg',
    ...
    array(
      ...
      'import_widget_file_url'     => PERGO_URI.'/admin/demo-data/widgets.wie',
      'import_customizer_file_url' => PERGO_URI.'/admin/demo-data/customizer.dat', 
      'import_preview_image_url'   => '//jthemes.org/wp/pergo/assests/images/layout-24.jpg',
    ...
    array(
      ...
      'import_widget_file_url'     => PERGO_URI.'/admin/demo-data/widgets.wie',
      'import_customizer_file_url' => PERGO_URI.'/admin/demo-data/customizer.dat', 
      'import_preview_image_url'   => '//jthemes.org/wp/pergo/assests/images/layout-25.jpg',
    ...
    array(
      ...
      'import_widget_file_url'     => PERGO_URI.'/admin/demo-data/widgets.wie',
      'import_customizer_file_url' => PERGO_URI.'/admin/demo-data/customizer.dat', 
      'import_preview_image_url'   => '//jthemes.org/wp/pergo/assests/images/layout-26.jpg',
    ...
    array(
      ...
      'import_widget_file_url'     => PERGO_URI.'/admin/demo-data/widgets.wie',
      'import_customizer_file_url' => PERGO_URI.'/admin/demo-data/customizer.dat', 
      'import_preview_image_url'   => '//jthemes.org/wp/pergo/assests/images/layout-27.jpg',
    ...
    array(
      ...
      'import_widget_file_url'     => PERGO_URI.'/admin/demo-data/widgets.wie',
      'import_customizer_file_url' => PERGO_URI.'/admin/demo-data/customizer.dat', 
      'import_preview_image_url'   => '//jthemes.org/wp/pergo/assests/images/layout-28.jpg',
    ...
    array(
      ...
      'import_widget_file_url'     => PERGO_URI.'/admin/demo-data/widgets.wie',
      'import_customizer_file_url' => PERGO_URI.'/admin/demo-data/customizer.dat', 
      'import_preview_image_url'   => '//jthemes.org/wp/pergo/assests/images/layout-multi.jpg',
      'preview_url'                => '//jthemes.org/wp/pergo/demos/',
    ),
    array(
      ...
      'import_preview_image_url'   => '//jthemes.org/wp/pergo/assests/images/layout-shop.jpg',
      'preview_url'                => '//jthemes.org/wp/pergo/woo/',
    ),
...
function pergo_after_import( $selected_import ) {
  ...
  $options = pergo_get_optiontree_layout(true);
