...
function pergo_register_required_plugins( ) {
    $plugins = array(
        ...
        array(
            ...
            'source' => get_template_directory() . '/tgmpa/plugins/perch_modules-1.0.1.zip', // The plugin source.
            'required' => true,
            'version' => '1.0.1',
            'force_activation' => false, 
            'force_deactivation' => false, 
        ...
        array(
            ...
            'source' => get_template_directory() . '/tgmpa/plugins/convertplug-3.4.1.zip', // The plugin source.
            'required' => 0,
            'version' => '3.4.1',
            'force_activation' => 0, 
        ...
        array(
            ...
            'source' => get_template_directory() . '/tgmpa/plugins/revslider-5.4.8.3.zip', // The plugin source.
            'required' => false,
            'version' => '5.4.8.3',
            'force_activation' => false,
            'force_deactivation' => false 
        ...
        array(
             'name' => __( 'Page Builder Gutenberg Blocks', 'pergo' ),
            'slug' => 'coblocks',
            'required' => false 
        ),
        array(
